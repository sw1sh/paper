\begin{abstract}
In order to establish an electronic structure of strongly correlated material, the most famous and effective way is to address the Dynamical mean-field theory.
...
Especially we need to know whether a two-particle vertex is enough to describe the system, and high-order momenta are therefore redundant.
The only way to check this is to derive an expression for the sixth order vertex and compare them.
\end{abstract}